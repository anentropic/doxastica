...
This document provides guidance for developers working on doxastica.
...
# Test coverage
uv run pytest --cov=src/doxastica --cov-report=term
```
...
```
doxastica/
├── src/doxastica/      # Package source code
...
# Place in src/doxastica/py.typed (marker only)
# or src/doxastica/*.pyi (stub files)
```
...
1. Ensure your IDE uses Python 3.14+
